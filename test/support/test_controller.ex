defmodule TestUserController do
  ...
  def show(%{id: id}, _query_params, _headers, _body) do
    case id do
  ...
  def update(%{id: _id}, _query_params, _headers, body) do
    {200, %{}, %TestUser{id: 1, name: body.name, email: body.email}}
  end

  @spec delete(%{id: String.t()}, %{}, %{}, nil) :: {204, %{}, nil}
  def delete(%{id: _id}, _query_params, _headers, _body) do
    {204, %{}, nil}
  end

  @spec show_by_integer_id(%{id: integer()}, %{}, %{}, nil) :: {200, %{}, TestUser.t()}
  def show_by_integer_id(%{id: id}, _query_params, _headers, _body) do
