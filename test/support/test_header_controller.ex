defmodule TestHeaderController do
  ...
  def list_with_count(_path_args, _query_params, _headers, _body) do
  ...
  def list_with_string_count(_path_args, _query_params, _headers, _body) do
  ...
  def ping(_path_args, _query_params, headers, _body) do
  ...
  def search(%{id: id}, _query_params, _headers, _body) do
    case id do
      "1" ->
